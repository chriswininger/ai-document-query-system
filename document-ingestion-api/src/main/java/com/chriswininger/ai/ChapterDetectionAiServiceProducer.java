...
@ApplicationScoped
public class ChapterDetectionAiServiceProducer {
    ...
    @Produces
    @ApplicationScoped
    public ChapterDetectionAiService chapterDetectionAiService() {
        ...
        return AiServices.create(ChapterDetectionAiService.class, jsonModel);
    }
}
