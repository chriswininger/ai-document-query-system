...
@ApplicationScoped
public class ChapterServiceBackup {

    private static final Logger LOG = Logger.getLogger(ChapterServiceBackup.class);
    ...
    private Map<String, Object> trySplitNode(ChapterState state) {
        ...
        LOG.infof("splitString identified: %s", splitString);
